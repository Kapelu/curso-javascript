...
![no-box](./_img/04-EstructuraDeDatos-I/notatree2.png)

Este otro no es un árbol porque tiene un ciclo:

![no-box](./_img/04-EstructuraDeDatos-I/notatree1.png)
...
![Dom](./_img/04-EstructuraDeDatos-I/dom_tree.gif)
...
![no-box](./_img/04-EstructuraDeDatos-I/binaryTree.png)
...
![BalancedUnBalanced](./_img/04-EstructuraDeDatos-I/Balanced_vs_unbalanced_BST.png)
...
![BinaryArray](./_img/04-EstructuraDeDatos-I/binaryArray.png)
...
![avl](./_img/04-EstructuraDeDatos-I/avl.gif)
...
![no-box](./_img/04-EstructuraDeDatos-I/heap.png)
