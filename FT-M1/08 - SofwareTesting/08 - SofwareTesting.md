...
![Piramide](./_img/EXTRA-Testing/piramide.png)
...
![Test Overhead](./_img/EXTRA-Testing/testOverhead.jpg)
...
![TDD](./_img/EXTRA-Testing/TDD.png)
...
![Demo Test](./_img/EXTRA-Testing/demo-test.png)
...
![Describe Demo](./_img/EXTRA-Testing/describe-demo.png)
...
![Skip](./_img/EXTRA-Testing/skip.png)
...
![it only](./_img/EXTRA-Testing/it-only.png)
...
![describe only](./_img/EXTRA-Testing/describe-only.png)
