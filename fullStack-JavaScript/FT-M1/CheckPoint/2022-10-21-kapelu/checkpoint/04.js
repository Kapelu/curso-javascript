 ...
 * asas(10) => 'No se puede construir casas con esa cantidad de bolsas'
 * REQUISITOS:
 *  🟢
 */
function construccionCasas(bolsas) {
	let bolsasPorCasas = bolsas / 10
	return function (casas) {
		...
		else if (casas > bolsasPorCasas) return `Solo puedes construir esta cantidad de casas: ${Math.floor(bolsasPorCasas)}`
		else if (casas % bolsasPorCasas === 0) return true
	}
}
